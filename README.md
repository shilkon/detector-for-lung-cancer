...
### Доска проекта
https://ru.yougile.com/team/88e5b5bbf9bc/Detector-for-lung-cancer
...
5) В качестве юнит-тестов представлена визуализация данных в ноутбуках explore_data и augmented_explore_data. Фрагмент визуализации:
